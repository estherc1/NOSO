           ...
           # html.Div([
            dcc.Tabs(id="tabs", value='tab-1',children=[
                ...
                "border": "2px solid #4286f4" }
                        ...
                        html.Div([
                            html.H3('Probability of Customer Returning Next Month'),

                            dcc.Dropdown(
                                id='customer_next_month',
                                options=[
                                {'label': i, 'value': i} for i in df.ID.unique()
                             ],
                            placeholder='Select customer...'
                            ...
                            html.Div([
                            html.H1(id='next_month_prob')
                            ], style={'margin-left': '240px', 'margin-top':"50px", "font-weight": "bold", "font-size": "50%"}
                            )

                            ],style={"float":"right", "margin-top": "30px", "margin-left": "280px", "margin-right": "5%","background-color": "white", "height": "325px", "width": "40%", "padding-right": "20px", "padding-left": "20px", "border-radius": "25px",
                            "border": "2px solid #4286f4" }
                    ...
                    html.Div([
                        ...
                        ], style = {'width':'95%', 'margin-top': '20px', 'margin-left': '15px', 'margin-bottom': '20px'})
                        ...
                        "border": "2px solid #4286f4", "margin-top": "-620px"}
                    )
             ...
             #   ])
                ...
                dcc.Tab(label='Recommendation', 
                    ...
                    html.Div([
                        ...
                        ###########
                        html.Div([
                        html.H3(children='US Jewelry House Dashboard - Sample Recommendation Engine by Line Item')
                        ...
                        html.Div([
                            ...
                            html.Div(id='input3')                        
                        ], style={"float":"left", "margin-top": "20px", "background-color": "white", "margin-right": "2%", "margin-left": "5%", "width": "25%", "padding-right": "20px", "padding-left": "20px", "border-radius": "25px",
                        ...
                        html.Div([
                            ...
                            html.Div(id='input4')                       
                        ], style={"float":"left", "margin-top": "20px", "background-color": "white", "margin-right": "2%", "width": "25%", "padding-right": "20px", "padding-left": "20px", "border-radius": "25px",
                            "border": "2px solid #4286f4","height":"500px"}),
                ...
                dcc.Tab(label='About This Project', 
                    ...
                    html.Div([
                        ...
                        html.P("As our final project at the data science bootcamp at the NYC Data Science Academy, we completed a start-to-end data science consulting project for U.S. Jewelry House."),
                        html.P("The objective of this project was to creatively derive insights that can help to create value and target customers more effectively based on their purchase history and the items they have bought before. To achieve this, we systematically worked with the data we received, from understanding and cleaning the data to brainstorming what models and approaches could yield the best business insights to putting our final result into production and presenting our findings."),
                        html.P( "To see our presentation and code, check out our GitHub repository."), html.A("Link to our GitHub repository",href="https://github.com/estherc1/NOSO", target="blank")
...
@app.callback(
    Output('next_month_prob', 'children'),
    [Input('customer_next_month', 'value')])
def next_month_purchase(name):
    if name is not None:
        try:
            prob = int(next_month[next_month['ID']==name]['Probability'])
            return(str(prob) + '%')
        except ValueError:
            return 'Invalid Input'
